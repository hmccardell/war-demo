...
public class Constants {
    ...
    public final static String INTRODUCTION = "\n\nWelcome to War!\nHow many will be playing? (Enter a numeral between 2 and 4): ";
    ...
    public final static void displayRemovalFromGame(Player player){
        System.out.println(player.getName() + " ran out of cards and was removed from the game. Thanks for playing!");
    }
